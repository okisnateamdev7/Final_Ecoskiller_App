 ...
 * Identical pattern to application-service; dispatch goes to ToolRouter.
 */
        ...
        try {
            ...
            switch (method) {
                case "initialize":
                    ...
                    res.put("protocolVersion", com.ecoskiller.mcp.AssessmentOrchestratorMCPServer.MCP_VERSION);
                    res.put("capabilities", JsonUtil.obj("tools", "{}"));
                    Map<String, Object> info = new LinkedHashMap<>();
                    info.put("name",    com.ecoskiller.mcp.AssessmentOrchestratorMCPServer.SERVER_NAME);
                    info.put("version", com.ecoskiller.mcp.AssessmentOrchestratorMCPServer.SERVER_VERSION);
