package com.ecoskiller.antigravity.cat13.model;
 ...
 * CAT-13: Enterprise Optimization + Trust Infrastructure — ANTIGRAVITY SEALED
 */
public class McpModels {
    ...
    public static class PropSchema {
        ...
        public PropSchema(String type, String description) {
            this.type = type;
            this.description = description;
        }

        public PropSchema(String type, String description, List<String> enumValues) {
            this.type = type;
            this.description = description;
    ...
    public static class ToolCallResult {
        ...
        public ToolCallResult(String text, boolean isError) {
            this.content = List.of(new ContentBlock("text", text));
    ...
    public static class AgentResult {
        ...
        public String category = "CAT-13 Enterprise Optimization + Trust Infrastructure";
        public String mcpServer = "13. Enterprise Optimization + Trust Infrastructure";
