...
class ParentDashboardPage extends StatelessWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionTitle('WARD PERFORMANCE SUMMARY'),
  ...
  Widget _buildStatsRow() {
    return Row(
      children: [
        _buildStatCard('Score', '780', Colors.cyan),
        const SizedBox(width: 16),
        _buildStatCard('Rank', '#5', Colors.teal),
      ],
    );
  }
  ...
  Widget _buildActivityList() {
    return Column(
      children: [
        _buildActivityItem('Skill Test Passed', 'Python Basics', '2 hours ago'),
        const SizedBox(height: 12),
        _buildActivityItem('Project Submitted', 'Smart Home App', '1 day ago'),
      ],
    );
  }

  Widget _buildActivityItem(String activity, String detail, String time) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
      ...
      child: Row(
        children: [
          const Icon(LucideIcons.clock, color: Colors.cyan, size: 20),
          const SizedBox(width: 16),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(activity, style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
              Text(detail, style: GoogleFonts.inter(fontSize: 12, color: Colors.grey)),
            ],
          ),
          const Spacer(),
